...
[![Chance Logo](https://chancejs.com/logo.png)](https://chancejs.com)
...
Many more details on [https://chancejs.com](https://chancejs.com) but this single
...
1. Install dependencies from the root of the repo by running `yarn`
1. Ensure you have the yarn plugin for workspace installed via `yarn plugin import @yarnpkg/plugin-workspace-tools`
1. Run the tests via `npm test`
1. Make some fun new modules!
